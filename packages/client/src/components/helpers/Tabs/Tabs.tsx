...
import { createContextSelectable, useContextProxy, useContextSelector } from '@lesnoypudge/utils-react';
...
export type TabContext<VALUES extends ProvidedTabs> = {
...
export const TabsContext = createContextSelectable<
    TabContext<Record<string, ReactNode>>
>();


export const TabsContextProvider = <T extends ProvidedTabs>(props: TabContextProvider<T>) => {
...
export const CurrentTab: FC = () => {
    const currentTab = useContextSelector(TabsContext, (v) => v.currentTab);
