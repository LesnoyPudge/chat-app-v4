...
import { useConst, useContextProxy, useFunction, useMountedWrapper, useThrottle, withDisplayName } from '@lesnoypudge/utils-react';
...
export const UserMenu = withDisplayName('UserMenu', withDecorator(() => {
    ...
    const { closeOverlay } = useContextProxy(Dialog.Context);
